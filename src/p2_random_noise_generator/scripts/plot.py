...
if __name__ == "__main__":
    ...
    signal_u = vcd.getSignalByName('u')
    signal_u.setLabel('u(t)')
    ...
    signal_noise_y = vcd.getSignalByName('y_noise')
    signal_noise_y.setLabel('yn(t)')
    signal_noise_y.setType('int')
    # ----------------------------------------------------------- #
    ...
    bitstreamGraph.addSignal(signal_noise_y)
